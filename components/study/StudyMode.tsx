...
import { DEFAULT_DAILY_GOAL, getLocalDateISO } from "@/lib/study/studyCalendarUtils";
import {
  ...
  type StudyStartMode,
} from "@/lib/study/studySessionUtils";
...
export default function StudyMode({ deckId, deckName, cards, initialList, initialMode }: StudyModeProps) {
  ...
  useEffect(() => {
    ...
    if (initialMode === "today") {
      ...
      beginSession(todayCards, "Due Today", false, "study", "daily");
      return;
    }
